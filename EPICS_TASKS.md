...
| `E8` | In Progress | Runtime now assembles tool-call events and executes registry tools (`read_file`) with policy/path guards; approvals/audit/delegation flow remains pending. |
