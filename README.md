...
- Event-driven runtime processing (stream events + channel message queues), with `DomainEvent`/`EventBus` core contracts implemented and bounded bus migration tracked in backlog.
