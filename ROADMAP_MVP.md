...
| Single-orchestrator topology profile | Partial (chat runtime has delegated control-plane baseline commands with bounded assignment checks; execution loop pending) |
