...
mod tests {
    ...
    #[test]
    fn context_window_uses_default_and_override() {
        assert_eq!(
            AnthropicEngine::resolve_context_window_tokens("claude-3-5-sonnet-latest", None),
            200_000
        );
        assert_eq!(
            AnthropicEngine::resolve_context_window_tokens("custom-model", Some(65_536)),
            65_536
        );
    }
    ...
    fn max_output_tokens_uses_fallback_and_override() {
        assert_eq!(
            AnthropicEngine::resolve_max_output_tokens(200_000, None),
            8_192
        );
        assert_eq!(
            AnthropicEngine::resolve_max_output_tokens(8_192, None),
            1_024
        );
        assert_eq!(
            AnthropicEngine::resolve_max_output_tokens(200_000, Some(10_000)),
            10_000
        );
    }
}
