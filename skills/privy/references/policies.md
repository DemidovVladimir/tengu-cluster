...
| `eth_signUserOperation` | Sign user operation (ERC-4337) |
| `eth_sign7702Authorization` | Sign EIP-7702 authorization |
| `signTransaction` | Sign Solana transaction |
| `signAndSendTransaction` | Sign and send Solana transaction |
| `signTransactionBytes` | Sign Solana transaction bytes |
| `exportPrivateKey` | Export private key |
| `*` | All methods (use carefully!) |

**Note:** `personal_sign` is NOT a policy method — it is always allowed and does not need a policy rule.
